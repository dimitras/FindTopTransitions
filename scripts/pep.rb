...
# mod1 (Acetyl (K)) contains 1 in the modification string position
# Acetyl (K)	0.00000000100000.0
# mod1 (Acetyl:2H(3) (K)) contains 2 in the modification string position
# Acetyl:2H(3) (K)	0.00000000200000.0
MODS = {'K1' => 42.010565, 'K2' => 45.029395}
...
MW = {
  ...
  'Y' => 163.063329,
  'V' => 99.068414,
  "K1" => 128.094963 + MODS['K1'],
  "K2" => 128.094963 + MODS['K2']
}
